...
def get_model():
	...
	a = Softmax(a)
	model = Model(a)
	model.compile(optimizer='SGD', lr=0.0006, decay_rate=0.99998 , loss='cross_entropy')
	return model
...
if __name__ == '__main__':
	...
	hist = model.update(X_train, Y_train, batch_size=32, trainig_epoch=3000, 
				X_val=X_test, Y_val=Y_test, validate_every_n_epoch=50, record_every_n_epoch=5)
